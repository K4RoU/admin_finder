#@this tools is created by K4aroU
#@author => www.github.com/K4roU
#lastest Update On 2021 September
...
w ="\033[0;1m"
p ="\033[95;1m"
#colour code ending here
parse = argparse.ArgumentParser()
parse.add_argument('_u')
#logo start here *****************
def logo () :
    print(f"""{o}
             __    __    __     __                             __       __
          ...
          {g}-------------------{r}Made by K4roU :<{y} {g}-----------------------------
          {g}-------------------{r}Admin Pannel Finder {y} {g}-----------------------------""")
...
def internet(): 
    try:
        ...
        if res.status_code == 200:
            ...
            print(f"{y}[{r}!{y}] {g} Something went wrong! Try Again")
    except KeyboardInterrupt:
...
url = str(input("\033[97m Enter the website : \033[91"))
...
for i in adminlist:
    ...
    try:
        ...
        print("")
        print("\033[92mI Foand Something : "+openurl)
        print("")
    except:
        print("\033[91mOops Nothing foand on : "+url_try)

print("Thanks For using My Admin Finder ! ")
